...
L["Announce your target (a rare mob)."] = true
...
L["Get Anounce Rare on Curse/Twitch"] = true
...
L["I have split this off into its own addon, so ElvUI and ElvUI Chat Tweaks are not required. Copy the link in the text box to get the new addon."] = true
L["Icon Action"] = true
...
L["Target the rare and then type |cff00ff00/rare|r to announce it in general chat."] = true
...
L["When you target a rare in Mechagon or Nazjatar, and it is alive, it will announce to general. There is a built in throttle to only send a message every 30 seconds."] = true
